...
import BeautySpaCard from "../components/beauty-spa-card";
...
const Blog: FunctionComponent = () => {
  ...
  return (
    <div
      className="relative [background:linear-gradient(#fff,_#fff),_#fff] w-full h-[2702px] overflow-hidden [&.animate]:animate-[1s_ease_0s_1_normal_forwards_slide-in-top] opacity-[0]"
      data-animate-on-scroll
    >
      <ContainerFooter
