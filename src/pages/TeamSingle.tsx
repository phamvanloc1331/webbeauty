...
import BeautyCenterCard1 from "../components/beauty-center-card1";
import TeamCard from "../components/team-card";
import BeautyForm from "../components/beauty-form";

const TeamSingle: FunctionComponent = () => {
  useEffect(() => {
  ...
  return (
    <div
      className="relative [background:linear-gradient(#fffbf7,_#fffbf7),_#fff] w-full h-[2179px] overflow-hidden flex flex-col items-center justify-start [&.animate]:animate-[1s_ease_0s_1_normal_forwards_slide-in-top] opacity-[0]"
      data-animate-on-scroll
    >
