...
const Team: FunctionComponent = () => {
  ...
  return (
    <div
      className="relative [background:linear-gradient(#fffbf7,_#fffbf7),_#fff] w-full h-[2863px] overflow-hidden flex flex-col items-center justify-start [&.animate]:animate-[1s_ease_0s_1_normal_forwards_slide-in-top] opacity-[0]"
      data-animate-on-scroll
    >
