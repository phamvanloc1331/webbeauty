...
type BeautySpaContainer1Type = {
  imageDescription?: string;
  beautySpaDescription?: string;
  imageCode?: string;
  bodyImprovementTips?: string;
  imageCodeDescription?: string;
  hydrotherapyOrSwimDescrip?: string;
};

const BeautySpaContainer1: FunctionComponent<BeautySpaContainer1Type> = memo(
  ({
    imageDescription,
    ...
    hydrotherapyOrSwimDescrip,
  }) => {
    return (
      <div className="relative w-[1200px] h-[579px] text-left text-smi text-slategray font-manrope">
        <Link
          className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[830px] w-[370px] flex flex-col items-start justify-start text-[inherit]"
          to="/blogsingle"
        >
          <img
        ...
        <Link
          className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[414px] w-[370px] flex flex-col items-start justify-start text-[inherit]"
          to="/blogsingle"
        >
          <img
            className="relative w-[370px] h-[325px] object-cover"
        ...
        <Link
          className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[0px] w-[370px] flex flex-col items-start justify-start text-[inherit]"
          to="/blogsingle"
        >
          <img
            className="relative w-[370px] h-[325px] object-cover"
            alt=""
            src={imageCodeDescription}
          />
          <div className="bg-aliceblue-100 flex flex-col items-start justify-start py-[30px] pr-[27px] pl-[26px]">
            <div className="w-[317px] h-[194px] flex flex-col items-start justify-start gap-[8px]">
              <div className="relative w-[306.4px] h-4">
...
export default BeautySpaContainer1;
