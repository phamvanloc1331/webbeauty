...
type ContainerFooterType = {
  ...
  carImageDimensions?: string;

  /** Style props */
  contentTop?: CSSProperties["top"];
  contentLeft?: CSSProperties["left"];
  contentAlignItems?: CSSProperties["alignItems"];
  contentPadding?: CSSProperties["padding"];
  contentBoxSizing?: CSSProperties["boxSizing"];
  copyright2021DraftedContaAlignItems?: CSSProperties["alignItems"];
};

const ContainerFooter: FunctionComponent<ContainerFooterType> = memo(
  ({
    imageDimensions,
    carImageDimensions,
    contentTop,
    ...
    contentPadding,
    contentBoxSizing,
    copyright2021DraftedContaAlignItems,
  }) => {
    ...
    }, [contentAlignItems, contentPadding, contentBoxSizing]);

    const copyrightStyle: CSSProperties = useMemo(() => {
      return {
        alignItems: copyright2021DraftedContaAlignItems,
      };
    }, [copyright2021DraftedContaAlignItems]);

    return (
      <div
        className="absolute top-[8312px] left-[calc(50%_-_960px)] w-[1920px] flex flex-col items-center justify-start text-left text-21xl text-white font-playfair-display"
        style={footerStyle}
      >
        <div
          className="bg-darkslategray-200 w-[1919px] h-[560px] flex flex-col items-center justify-center"
          style={contentStyle}
        >
          <div className="w-[1200px] flex flex-col items-start justify-start gap-[52px]">
            <div className="w-[1199px] flex flex-row items-center justify-start gap-[651px]">
              ...
              <div className="flex flex-row items-center justify-end gap-[10px] text-center text-lg ">
                <div className="box-border w-[55px] h-[55px] flex flex-col items-center justify-center border-[2px] border-solid border-slategray">
                  <div className="relative tracking-[0.06em] leading-[100%] uppercase">
                    f
                  </div>
                </div>
                ...
                <div className="box-border w-[55px] h-[55px] flex flex-col items-end justify-start py-[15px] px-[13px] border-[2px] border-solid border-slategray">
                  <div className="relative tracking-[0.06em] leading-[100%] uppercase">
                   in
                  </div>
                </div>
        ...
        <div
          className="bg-gray-100 w-[1920px] h-[75px] flex flex-col items-center justify-end py-[19px] px-0 box-border text-center text-mini font-font-awesome-5-free"
